...
{
    public $result;
    public function __construct($tablename, $id, $del, $code, $name, $record, $land_id, $posted)
    {
            parent::__construct($tablename, $id , $del, $code, $name, $record, $land_id, $posted);
...
//        }
  ...
  //--------------------------------------------------------------------------------------------------------------------------------- 
    protected function formContent()
        {
            echo "<form action='' method='POST' name='editform' autocomplete>";
            $this->formFill();
            echo "</form>";
        }
  //--------------------------------------------------------------------------------------------------------------------------------- 
